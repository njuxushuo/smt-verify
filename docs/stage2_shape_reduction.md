...
```bash
python scripts/reduce_shapes.py input/broadcast/matmul_batched/matmul_shard_to_partial.json
python scripts/reduce_shapes.py input/broadcast/matmul_batched/matmul_shard_to_partial_large.json
```
